...
const SimulatorPortfolioPage = () => {
    ...
    const handleSelectChange = (event: any) => {
        ...
        axios.get('https://api.twelvedata.com/time_series?&start_date=' + finalStr2 + '&symbol=' + String(selectedValue) + `&interval=1month&apikey=${process.env.TWELVEDATA_API_KEY}`).then((response) => {
