...
const Av3 = require('../../images/avatars/av3.png')
const Av4 = require('../../images/avatars/av4.png')
const Av5 = require('../../images/avatars/av5.png')
...
const ProfilePage = () => {
  ...
  const avatars = [
    ...
    { img: Av2, string: '../../images/avatars/av2.png' },
